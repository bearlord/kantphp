...
class KantRegistry extends ArrayObject {
     ...
     * @var string
     */
    private static $_registryClassName = 'KantRegistry';
     ...
     *
     * @param Kant_Registry $registry An object instance of type Kant_Registry,
     *   or a subclass.
     * @return void
     * @throws Exception if registry is already initialized.
     */
    public static function setInstance(KantRegistry $registry) {
        if (self::$_registry !== null) {
     ...
     */
    public static function setClassName($registryClassName = 'Kant_Registry') {
        if (self::$_registry !== null) {
            throw new Exception('Registry is already initialized');
        }
